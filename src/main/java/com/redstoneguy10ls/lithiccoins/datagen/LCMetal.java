...
public enum LCMetal
{
    ...
    CHROMIUM(CoinMaterial.CHROMIUM, new MetalType("chromium", "firmalife", 1250f, 4)),
    ...
    STAINLESS_STEEL(CoinMaterial.STAINLESS_STEEL, new MetalType("stainless_steel", "firmalife", 1540f, 4)),
